 ...
 */
public class MovimentoLivre implements Mobilidade{
    ...
    public UnidadeDeMonitoramentoImagem configurarImagemDoRobo(UnidadeDeMonitoramentoImagem panel) {
        javax.swing.ImageIcon img = new javax.swing.ImageIcon("./src/res/movimentolivre.png");
    ...
    public double calcularDistancia(int linhaAtual, int colunaAtual, int linhaNova, int colunaNova) {
        return sqrt ( pow(linhaAtual - linhaNova, 2) + pow(colunaAtual - colunaNova, 2) );
    }
